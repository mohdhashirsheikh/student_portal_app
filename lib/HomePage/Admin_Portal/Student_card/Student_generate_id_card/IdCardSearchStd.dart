...
import 'package:student_portal_app/HomePage/Admin_Portal/Student_card/Student_generate_id_card/GenerateStudentIdCard.dart';

class IdCardSearchStudent extends StatefulWidget {
  IdCardSearchStudent({Key? key}) : super(key: key);

  @override
  _IdCardSearchStudentState createState() => _IdCardSearchStudentState();
}

class _IdCardSearchStudentState extends State<IdCardSearchStudent> {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        studentDetails = studentData[index];
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => GenerateStudentIdCard(
